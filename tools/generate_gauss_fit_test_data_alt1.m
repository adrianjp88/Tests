function [data, true_parameters, initial_guess_parameters] = ...
    generate_gauss_fit_test_data_alt1(n_fits, fit_size, mean_amplitude, mean_width, ...
    ...
    initial_guess_xpos_offset = (initial_guess_xpos_offset_max/2.0) ...
                                + (initial_guess_xpos_offset_max/2.0) ...
                                * (2*(rand(n_fits, 1) > 0.5) - 1);
